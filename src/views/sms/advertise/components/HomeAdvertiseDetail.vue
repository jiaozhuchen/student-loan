  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="homeAdvertise"
      ...
      <el-form-item label="背景颜色：" prop="backgroundColor">
        <el-color-picker v-model="homeAdvertise.backgroundColor" show-alpha :predefine="predefineColors"></el-color-picker>
      </el-form-item>
...
<script>
  ...
  import {createHomeAdvertise, getHomeAdvertise, updateHomeAdvertise,fetchCarouselTypeList} from '@/api/homeAdvertise'
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          backgroundColor: [
            {required: true, message: '请选择轮播背景色', trigger: 'blur'}
          ]
        },
        typeOptions: [],
        predefineColors: [
    ...
    methods: {
      ...
      getCateList(){
        fetchCarouselTypeList().then(response=>{
          let cateList = response.data;
          for(let i=0;i<cateList.length;i++){
            let cate = cateList[i];
            this.typeOptions.push({label:cate.value,value:cate.key});
          }
        })
      }
    }
